        ...
        return(
            ...
            <div className="container py-4">
                <div className="row py-5  ">
                    <div className="col-lg-4 col-md-4 col-sm-12 d-flex justify-content-center align-items-center flex-column py-2  new">
                        <div className="container bg-light d-flex justify-content-center align-items-center flex-column py-5 cont5 ">
                    ...
                    <div className="col-lg-4  col-md-4 col-sm-12 d-flex justify-content-center align-items-center flex-column  py-2 new">
                        <div className="container bg-light py-3 cont5 d-flex justify-content-center align-items-center py-5 flex-column">
                        <div className="circle bg-light    d-flex justify-content-center align-items-center ">
                            <h2 className="clr">{<BsFillSuitHeartFill/>}</h2>
                        </div>
                        <p className="para1 text-center  m-0 p-0 mt-5 ">Best industry experts</p>
                    ...
                    <div className="col-lg-4  col-md-4 col-sm-12 d-flex justify-content-center align-items-center flex-column py-2 new ">
                        ...
                        <p className="para1 text-center  m-0 p-0 mt-5 py-2">See our best skills</p>
